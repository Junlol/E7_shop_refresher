...
while not keyboard.is_pressed('q') or not (buy_covenants and buy_mystics):
    ...
    in_shop = pyautogui.locateCenterOnScreen("images/shop.png", confidence=.90)
    ...
    if in_shop:
        ...
        # mystic bookmarks
        mystic = pyautogui.locateCenterOnScreen("images/mystic_icon.png", confidence=.90)

        # covenant bookmarks
        covenant = pyautogui.locateCenterOnScreen("images/covenant_icon.png", confidence=.90)

        # refresh button
        refresh_button = pyautogui.locateCenterOnScreen("images/refresh_button.png", confidence=.90)
        ...
        if mystic and not bought_m and buy_mystics:
            ...
            mystic_confirm_buy_button = pyautogui.locateCenterOnScreen("images/mystic_buy_button.png",
                                                                       confidence=.80)
        ...
        if covenant and not bought_c and buy_covenants:
            ...
            wait(0.5)
            # find and click the confirm button
            covenant_confirm_buy_button = pyautogui.locateCenterOnScreen("images/covenant_buy_button.png",
                                                                         confidence=.80)
        ...
        if not searching:
            ...
            refresh_button_confirm = pyautogui.locateCenterOnScreen("images/confirm_refresh_button.png",
                                                                    confidence=.90)
